...
export const PromocodeModal = ({ setHasFooter }) => {
  ...
  const [whichPromocodeWasActivated, setWhichPromocodeWasActivated] =
    useState(null);
  ...
  return (
    <>
      <div className={styles.referal}>
        ...
        <div>
          <p
            className={`${styles.referal__subheader} ${styles['referal__address-subheader']}`}
          >
            Промокод
          </p>
          ...
          <ModalMainButton
            content="Ввести"
            setOnOpen={() => enterPromocodeHandler()}
          />

          <div
            className={`${styles.referal__subheader} ${styles.referal__info}`}
          >
            <div>
              <InfoIcon />
            </div>
            ...
            <p>
              {' '}
              Следите за промокодами в нашем
              <span> телеграмм канале</span>. Промокод можно активировать только
              один раз
            </p>
          </div>
        </div>
        ...
        <>
          ...
          <Overlay isClose={isSuccessClose}>
            ...
            <SuccessSection
              ...
              content={
                isSuccess
                  ? `Вы успешно активировали промокод ${whichPromocodeWasActivated}. Средства были зачислены вам на баланс`
                  : `Промокод ${whichPromocodeWasActivated} недействителен`
              }
            />
          </Overlay>
        </>
